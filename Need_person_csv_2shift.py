...
#     need_degree_a = 2 ##임의값 이부분에 대한 조정 필요!!
...
#     rows.append(row)
for day in range(1, 1+num_day): 
    need_person = random.randint(int(num_nurses*0.1) , int(num_nurses*0.2)) ##임의값
...
# CSV 파일 쓰기
with open("./chaejugchwah/output2.csv", mode="w", newline='') as file:
...
print("CSV 파일이 생성되었습니다: output2.csv")